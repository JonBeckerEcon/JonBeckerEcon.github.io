...
Micro-data reveals significant polarization in consumption patterns along the quality margin. Richer households opt for pricier goods and households are least price-elastic vis-a-vis their favored choice of quality. The exertion of market power is disciplined through moderately price-elastic middle-class consumers who are willing to substitute along the quality margin. Accommodating these features of the data, I study a partial equilibrium model of oligopolistic product market competition with nonhomothetic preferences. Firms' price-setting strategies are informed by the composition of their customer base. I demarcate a markup channel that allows for the expenditure distribution to affect macro aggregates. Observed shifts in spending patterns during the 2008-2009 financial crisis increase prices for low-quality goods by 7.25%, while decreasing prices for high-quality goods by 2.63%. Over the great recession, the markup channel accounts for approximately 15% of the welfare-losses for lower-income consumers and compensates affluent consumers for about 5% of their losses.
</small><br><br/></div> -->
